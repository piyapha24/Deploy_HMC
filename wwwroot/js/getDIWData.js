...
$(document).ready(function () {
    ...
    var dIWData = $('#dataTable').DataTable({
        ...
        columns: [
            ...
            {
                data: "contractExpireDate", render: function (data, type, row) {
                    ...
                    if (sums <= 79)
                        return `<div class="font-medium whitespace-nowrap text-success">${dates} KG</div>`;
                    else if (sums <= 89)
                        return `<div class="font-medium whitespace-nowrap text-warning">${dates} KG</div>`;
                    else if (sums <= 100)
                        return `<div class="font-medium whitespace-nowrap text-danger">${dates} KG</div>`;
                    return `<div class="font-medium whitespace-nowrap text-secondary">${dates} KG</div>`;  // Fallback for invalid sums
                },
                className: 'text-center'
            },
